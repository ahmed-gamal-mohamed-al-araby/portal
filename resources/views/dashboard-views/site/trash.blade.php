...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1>@lang('site.Trashed_sites')</h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                        <li class="breadcrumb-item active"> @lang('site.Trashed_sites')</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.site.pagination_data', ['pageType' => 'trashed'])
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {{-- Form to permanent delete or restore site --}}
...
@section('scripts')
    ...
    <script>
        ...
        languages['permanent_delete_site_title'] = "@lang('site.Delete') @lang('site.the_site')";
        languages['permanent_delete_site_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_site') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['permanent_delete_site_url'] = "{{ route('site.permanent_delete') }}";
        languages['permanent_delete_site_action_btn_text'] = "@lang('site.Permanent_delete')";


        languages['restore_site_title'] = "@lang('site.Restore') @lang('site.the_site')";
        languages['restore_site_body'] = "@lang('site.confirm') @lang('site.restore') @lang('site.the_site') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['restore_site_url'] = "{{ route('site.restore') }}";
        languages['restore_site_action_btn_text'] = "@lang('site.Restore')";
