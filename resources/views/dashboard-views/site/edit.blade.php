...
{{-- Custom Title --}}
@section('title')
    @lang('site.Edit') @lang('site.the_site')
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Edit') @lang('site.site')</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-layout">
                        {{-- Form to edit site --}}
                        <form action="{{ route('site.update', $site->id) }}" method="POST" id="editSite">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" value="{{ $site->name_ar }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_en" value="{{ $site->name_en }}"
                                        ...
                                        <select id='project' name="project_id" class="form-control" style="width: 100%;">
                                            ...
                                            @foreach ($projects as $project)
                                                <option value="{{ $project->id }}"
                                                    {{ $site->project->id == $project->id ? 'selected' : '' }}>
