            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Sectors')</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            <a href="{{ route('sector.create') }}" class="btn btn-success header-btn ">@lang('site.Add')
                                @lang('site.sector')</a>
                            <a href="{{ route('sector.trash') }}"
                                class="btn btn-warning header-btn ">@lang('site.Trashed_sectors')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.sector.pagination_data', ['pageType' => 'index'])
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        languages['delete_sector_title'] = "@lang('site.Delete') @lang('site.the_sector')";
        languages['delete_sector_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_sector') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['delete_sector_url'] = "{{ route('sector.trash') }}";
        languages['delete_sector_action_btn_text'] = "@lang('site.Delete')";
