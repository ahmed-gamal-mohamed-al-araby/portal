            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Groups')</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <a href="{{ route('group.trash') }}"
                                class="btn btn-warning header-btn ">@lang('site.Trashed_groups')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.group.pagination_data', ['pageType' => 'index'])
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        languages['delete_group_title'] = "@lang('site.Delete') @lang('site.the_group')";
        languages['delete_group_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_group') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['delete_group_url'] = "{{ route('group.trash') }}";
        languages['delete_group_action_btn_text'] = "@lang('site.Delete')";
