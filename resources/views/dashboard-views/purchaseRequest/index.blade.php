            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Purchase_requests')</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.purchaseRequest.pagination_data', ['pageType' => 'index'])
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        languages['delete_purchaseRequest_title'] = "@lang('site.Delete') @lang('site.the_purchase_request')";
        languages['delete_purchaseRequest_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_purchase_request') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['delete_purchaseRequest_url'] = "{{ route('purchase_request.trash') }}";
        languages['delete_purchaseRequest_action_btn_text'] = "@lang('site.Delete')";

        languages['sendforapprove_purchaseRequest_title'] = "@lang('site.Send') @lang('site.the_purchase_request')";
        languages['sendforapprove_purchaseRequest_body'] =
            "@lang('site.confirm') @lang('site.sending') @lang('site.the_purchase_request') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['sendforapprove_purchaseRequest_url'] = "{{ route('purchase_request.send_for_approve') }}";
        languages['sendforapprove_purchaseRequest_action_btn_text'] = "@lang('site.Send')";
                    ...
                    location.reload(); // then reload the page.
                        ...
                        if (response.code == 'PR_sent'){
                            toastr.success(
                                ...
                                $(
                                    `a[data-purchase_request_id="${basicData.purchaseRequest_id}"]`
