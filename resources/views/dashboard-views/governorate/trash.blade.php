...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1>@lang('site.Trashed_cities')</h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                        <li class="breadcrumb-item active"> @lang('site.Trashed_cities')</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            <a href="{{ route('governorate.create') }}"
                                class="btn btn-success header-btn ">@lang('site.Add') @lang('site.governorate')</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.governorate.pagination_data', ['pageType' => 'trashed'])
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {{-- Form to permanent delete or restore governorate --}}
...
@section('scripts')
    ...
    <script>
        ...
        languages['permanent_delete_governorate_title'] = "@lang('site.Delete') @lang('site.the_governorate')";
        languages['permanent_delete_governorate_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_governorate') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['permanent_delete_governorate_url'] = "{{ route('governorate.permanent_delete') }}";
        languages['permanent_delete_governorate_action_btn_text'] = "@lang('site.Permanent_delete')";


        languages['restore_governorate_title'] = "@lang('site.Restore') @lang('site.the_governorate')";
        languages['restore_governorate_body'] = "@lang('site.confirm') @lang('site.restore') @lang('site.the_governorate') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['restore_governorate_url'] = "{{ route('governorate.restore') }}";
        languages['restore_governorate_action_btn_text'] = "@lang('site.Restore')";
        // End defining languages

        // Start include pagination script
        const fetchDataURL =
            "{{ route('governorate.pagination.fetch_data') }}", // This valriable used in pagination_script
            pageType = 'trashed';
