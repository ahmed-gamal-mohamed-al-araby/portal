                ...
                <div class="col-12">
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <a href="{{ route('governorate.trash') }}"
                                class="btn btn-warning header-btn ">@lang('site.Trashed_cities')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.governorate.pagination_data', ['pageType' => 'index'])
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        languages['delete_governorate_body'] =
            ...
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['delete_governorate_url'] = "{{ route('governorate.trash') }}";
