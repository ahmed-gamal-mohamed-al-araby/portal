...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1>@lang('site.Trashed_sub_groups')</h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                        <li class="breadcrumb-item active"> @lang('site.Trashed_sub_groups')</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <a href="{{ route('sub-group.index') }}" class="btn btn-warning header-btn ">@lang('site.All')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.subGroup.pagination_data', ['pageType' => 'trashed'])
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        languages['permanent_delete_sub_group_title'] = "@lang('site.Delete') @lang('site.the_sub_group')";
        languages['permanent_delete_sub_group_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_sub_group') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['permanent_delete_sub_group_url'] = "{{ route('sub_group.permanent_delete') }}";
        languages['permanent_delete_sub_group_action_btn_text'] = "@lang('site.Permanent_delete')";

        languages['restore_sub_group_title'] = "@lang('site.Restore') @lang('site.the_sub_group')";
        languages['restore_sub_group_body'] = "@lang('site.confirm') @lang('site.restore') @lang('site.the_sub_group') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['restore_sub_group_url'] = "{{ route('sub_group.restore') }}";
        languages['restore_sub_group_action_btn_text'] = "@lang('site.Restore')";
