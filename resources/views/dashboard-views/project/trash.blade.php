...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1>@lang('site.Trashed_projects')</h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                        <li class="breadcrumb-item active"> @lang('site.Trashed_projects')</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row mb-3 justify-content-between">
                        ...
                        <div class="col-8 d-flex justify-content-end">
                            <a href="{{ route('project.index') }}"
                                class="btn btn-warning header-btn mx-2">@lang('site.All')
                                @lang('site.projects')
                                <span class="main-span"><span>
                            </a>
                            <a href="{{ route('project.completed_index') }}"
                                class="btn btn-warning header-btn ">@lang('site.Completed_projects')
                                <span class="main-span"><span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.project.pagination_data', ['pageType' => 'trashed'])
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {{-- Form to permanent delete or restore project --}}
...
@section('scripts')
    ...
    <script>
        ...
        languages['permanent_delete_project_title'] = "@lang('site.Delete') @lang('site.the_project')";
        languages['permanent_delete_project_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_project') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['permanent_delete_project_url'] = "{{ route('project.permanent_delete') }}";
        languages['permanent_delete_project_action_btn_text'] = "@lang('site.Permanent_delete')";


        languages['restore_project_title'] = "@lang('site.Restore') @lang('site.the_project')";
        languages['restore_project_body'] = "@lang('site.confirm') @lang('site.restore') @lang('site.the_project') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['restore_project_url'] = "{{ route('project.restore') }}";
        languages['restore_project_action_btn_text'] = "@lang('site.Restore')";
