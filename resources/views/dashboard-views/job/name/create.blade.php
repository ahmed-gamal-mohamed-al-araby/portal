...
{{-- Custom Title --}}
@section('title')
    @lang('site.Add') @lang('site.job_name')
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Add') @lang('site.job_name')</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-layout">
                        {{-- Form to create Job name --}}
                        <form action="{{ route('job-name.store') }}" method="POST" id="createJobName">
                            @csrf
                            <div class="row">
        ...
        $(function() {
            $('#createJobName').validate({
                ...
                messages: {
                    ...
                    job_code_id: {
                        required: " @lang('site.the_jobCode') @lang('site.is_required')",
                    },
                },
                errorElement: 'span',
