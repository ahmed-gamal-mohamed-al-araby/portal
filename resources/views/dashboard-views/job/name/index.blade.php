            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Job_names')</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            <a href="{{ route('job-name.create') }}" class="btn btn-success header-btn ">@lang('site.Add')
                                @lang('site.job_name')</a>
                            <a href="{{ route('job_name.trash') }}"
                                class="btn btn-warning header-btn ">@lang('site.Trashed_job_names')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.job.name.pagination_data', ['pageType' => 'index'])
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        languages['delete_job_name_title'] = "@lang('site.Delete') @lang('site.the_job_name')";
        languages['delete_job_name_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_job_name') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['delete_job_name_url'] = "{{ route('job_name.trash') }}";
        languages['delete_job_name_action_btn_text'] = "@lang('site.Delete')";
