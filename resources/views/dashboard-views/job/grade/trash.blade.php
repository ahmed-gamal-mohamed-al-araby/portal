...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1>@lang('site.Trashed_job_grades')</h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                        <li class="breadcrumb-item active"> @lang('site.Trashed_job_grades')</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <a href="{{ route('job-grade.index') }}" class="btn btn-warning header-btn ">@lang('site.All')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.job.grade.pagination_data', ['pageType' => 'trashed'])
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {{-- Form to permanent delete or restore job grade --}}
...
@section('scripts')
    ...
    <script>
        ...
        languages['permanent_delete_job_grade_title'] = "@lang('site.Delete') @lang('site.the_job_grade')";
        languages['permanent_delete_job_grade_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_job_grade') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['permanent_delete_job_grade_url'] = "{{ route('job_grade.permanent_delete') }}";
        languages['permanent_delete_job_grade_action_btn_text'] = "@lang('site.Permanent_delete')";


        languages['restore_job_grade_title'] = "@lang('site.Restore') @lang('site.the_job_grade')";
        languages['restore_job_grade_body'] = "@lang('site.confirm') @lang('site.restore') @lang('site.the_job_grade') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['restore_job_grade_url'] = "{{ route('job_grade.restore') }}";
        languages['restore_job_grade_action_btn_text'] = "@lang('site.Restore')";
