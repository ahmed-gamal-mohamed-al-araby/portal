            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Family_names')</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <a href="{{ route('family_name.trash') }}"
                                class="btn btn-warning header-btn ">@lang('site.Trashed_family_names')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.familyName.pagination_data', ['pageType' => 'index'])
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        languages['delete_family_name_title'] = "@lang('site.Delete') @lang('site.the_family_name')";
        languages['delete_family_name_body'] =
            "@lang('site.confirm') @lang('site.delete') @lang('site.the_family_name') " +
            "{{ $currentLanguage == 'ar' ? '؟' : '?' }}";
        languages['delete_family_name_url'] = "{{ route('family_name.trash') }}";
        languages['delete_family_name_action_btn_text'] = "@lang('site.Delete')";
