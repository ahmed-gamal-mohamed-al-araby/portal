...
{{-- Custom Title --}}
@section('title')
    @lang('site.Add') @lang('site.employee')
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Add') @lang('site.employee')</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-layout mb-3">
                        {{-- Form to create User --}}
                        <form action="{{ route('employee.store') }}" method="POST" id="createEmployee">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="position_ar" value="{{ old('position_ar') }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="Add Service ">@lang('site.Employee_code') </label>
                                        <input type="text" name="code" value="{{ old('code') }}" class="form-control"
                                            placeholder="@lang('site.Employee_code')">
                                    </div>
                                    @error('code')
                                        <p class="text-bold text-danger mt-n3 font-n8rem">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group ">
                                        ...
                                        <select id='job_code' class="form-control" style="width: 100%;">
                                            <option> </option>
